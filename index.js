/**
 * @desc javascript float math calculation
 * @author donghanji(http://donghanji.github.com)
 */
...
var FloatMath={
	...
	sub:function(){
		...
		var m=FloatUtil.pointMaxNum(FloatUtil.pointNums(args));
        var p=Math.pow(10,m);
		var total=Number(args[0])||0,i=1,l=args.length;
	...
	div:function(){
		...
		//
		var total=1;
		var n1=args[0]||1,i=1,l=args.length;
		//
        while(i<l){
        	var n2=args[i++];
